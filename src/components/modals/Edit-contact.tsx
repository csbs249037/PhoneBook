        ...
        <Dialog open={modalOpen} onOpenChange={handleClose}>
            <DialogContent className='p-0 text-black bg-white overflow-hidden'>
                <DialogHeader className='pt-8 px-6'>
                    <DialogTitle className='text-center text-2xl font-bold'>Edit Contact</DialogTitle>
                    <DialogDescription className='text-center text-zinc-500'>Edit your Contact details!!</DialogDescription>      
                </DialogHeader>
                <Form {...form}>
                ...
                <FormItem className="px-6 mb-2">
                    ...
                    <FormControl>
                    <Input placeholder="Enter Address" disabled={isLoading} {...field}/>
                    </FormControl>
                    <FormMessage/>
                </FormItem>
                )}>
                ...
                <FormItem className="px-6 mb-2">
                    ...
                    <FormControl>
                    <Input placeholder="Enter Email" type='email' disabled={isLoading} {...field}/>
                    </FormControl>
                    <FormMessage/>
                </FormItem>
                )}>
            ...
            <Button className="bg-green-600 hover:bg-green-500 hover:scale-90 transition" disabled={isLoading} onClick={form.handleSubmit(onSubmit)}>Save</Button>
            </DialogFooter>
            </DialogContent>
        </Dialog>
    )
